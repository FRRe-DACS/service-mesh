...
func RegisterFooServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FooServiceClient) error {
	...
	mux.Handle("POST", pattern_FooService_CreateFoo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_FooService_CreateFoo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_FooService_CreateFoo_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_FooService_CreateFoo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "foos"}, ""))
)
